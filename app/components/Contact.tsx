      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            ...
            <br />
            Je suis impatient de vous aider à atteindre vos objectifs de fitness
            et de bien-être !
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <input
                type="text"
                className="p-4 rounded-xl border text-black border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all"
